...
def on_hotkey_pressed():
    """
    Function to be triggered when the hotkey (Ctrl+Alt+F1) is pressed.
    """
...
# Set up the hotkey (Ctrl+Alt+F1) to trigger the on_hotkey_pressed function
keyboard.add_hotkey('ctrl+alt+f1', on_hotkey_pressed)

print("Press Ctrl+Alt+F1 to move the cursor to the next icon.")
